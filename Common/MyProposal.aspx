<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/eIPMasterPage.master" AutoEventWireup="true" CodeFile="MyProposal.aspx.cs" Inherits="Common_MyProposal" %>
        ...
        <ContentTemplate>
            <ajaxToolkit:TabContainer runat="server" ID="smtAjaxTabs" ActiveTabIndex="0" Width="99%">
                <ajaxToolkit:TabPanel runat="server" ID="pnlAwaiting" HeaderText="Awaiting Approval" Visible="true">
                    ...
                    <ContentTemplate>
                        <uc2:IPInitiatorPendingProposals ID="IPInitiatorPendingProposals"  runat="server" />                
                    </ContentTemplate>
                ...
                <ajaxToolkit:TabPanel runat="server" ID="pnlApproved" HeaderText="Approved PPS Code" Visible="true">
                    ...
                    <ContentTemplate>
                        <uc1:IPInitiatorApprovedProposals ID="IPInitiatorApprovedProposals"  runat="server" />                              
                    </ContentTemplate>
