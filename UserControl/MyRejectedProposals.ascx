<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyRejectedProposals.ascx.cs" Inherits="UserControl_MyRejectedProposals" %>

<table class="tMainBorder" style="width: 100%">
    <tr>
        <td class="cHeadTile">
            <asp:Label ID="Label1" runat="server" Font-Bold="True"
                Text="Rejected Proposals" ForeColor="#003366"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
