...
public partial class UserControl_MyRejectedProposals : aspnetUserControl
{
    ...
    protected void pendingProposalGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        LoadRejectedProposals(oSessnx.getOnlineUser);
    }

    public void LoadRejectedProposals(appUsers OnlineUser)
    {
        SupportApproverCommentMgt oSupportApproverCommentMgt = new SupportApproverCommentMgt();
        DataTable dt = new DataTable();

        dt = oSupportApproverCommentMgt.MyRejectedProposal(OnlineUser.m_iUserId);
