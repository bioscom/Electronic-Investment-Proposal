...
public partial class Reports_rptDeletedIPs : System.Web.UI.Page
{
    ...
    {
        ReportGenerator("rptDeletedProposals", "Report_Proposals", LoadDeletedProposals());
    }
    ...
    private DataTable LoadDeletedProposals()
    {
    ...
    private string BaseQuery()
    {
        ...
        sql += "EIP_PROPOSAL.STATUS = '" + IPStatus.Deactivated + "' ";
