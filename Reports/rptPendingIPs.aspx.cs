...
public partial class Reports_rptPendingIPs : System.Web.UI.Page
{
    ...
    {
        ReportGenerator("rptPendingProposals", "Report_Proposals", LoadPendingProposals());
    }
    ...
    private DataTable LoadPendingProposals()
    {
    ...
    {
        string sql = "SELECT EIP_PROPOSAL.PROJ_NUM, EIP_PROPOSAL.PROJ_TITLE, TO_CHAR(EIP_PROPOSAL.DATE_INIT, 'DD-MM-YYYY')DATE_INIT, EIP_PROPOSAL.JV, EIP_PROPOSAL.SS, ";
        sql += "TO_CHAR(EIP_PROPOSAL.DATE_SUBMIT, 'DD-MM-YYYY')DATE_SUBMIT, EIP_PROPOSAL.DOC_STAND, EIP_PROPOSAL.STATUS, EIP_PROPOSAL.PROJ_DESC, CPDMS_EPPRIORITY.EPPRIORITY, ";
        sql += "TO_CHAR(EIP_PROPOSAL.DATE_LAST_ACTIONED, 'DD-MM-YYYY')DATE_LAST_ACTIONED, EIP_USERMGT.FULLNAME, EIP_USERMGT.IDUSERMGT, CPDMS_SHELLCOMPANIES.COMPANYNAME, ";
        ...
        sql += "EIP_PROPOSAL.DOC_STAND = '" + SupportState.iNotApproved + "' AND EIP_PROPOSAL.STATUS = '" + IPStatus.Activated + "' ";
        return sql;
    }
