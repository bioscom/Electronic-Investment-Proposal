...
public partial class BPO_IPWFOverRider : aspnetPage
{
...
//private void GetCorporatePlanningManagerComment()
//{
//    //int EPNIGERIALOGIC = proposal.OriginatingUnit(proposal);

//    CorporatePlanningManager cpm = new CorporatePlanningManager(proposal.IDPROPOSAL);
//    if (cpm.iSTAND == SupportState.iSupported)  //ds.Tables[0].Rows[0].IsNull("FORWARDEDTOMD"))
//    {
//        lblCPMStand.Text = SupportState.Supported;
//        lblCPMStand.ForeColor = System.Drawing.Color.Green;
//    }
//    else if (cpm.iSTAND == SupportState.iNotSupported)
//    {
//        //CPMStandLabel.Text = "Not Yet Actioned";
//        lblCPMStand.Text = SupportState.NotSupported;
//        lblCPMStand.ForeColor = System.Drawing.Color.Red;
//    }

//    //CPMCommentLabel.Text = cpm.sCOMMENTS;
//    lblCPM.Text = cpm.sFULLNAME;
//    SupportStatusCode(cpm.iSTAND, lblCPMStand, btnCPM);
//}

//private void GetFunctionalSupportComments()
//{
//    try
//    {
...
//        {
//            //directorCommentLabel.ForeColor = System.Drawing.Color.Red;
//            //directorCommentLabel.Text = "MD Support is required if MD OU is not the Final Approver.";
...
//private void GetFinanceSignatureComments()
//{
//    try
//    {
//        FinanceSignatureComments MyComment = new FinanceSignatureComments(proposal.IDPROPOSAL);
//        appUsers MyRole = new appUsers(MyComment.iIDUSERMGT);
//        if (MyComment.FinanceSignatureReceivedIP())
//        {
//            lblFinanceStand.Text = MyStand(MyComment.iSTAND);
//            //financeCommentLabel.Text = MyComment.sCOMMENTS;
//            lblFinSignature.Text = MyRole.sFULLNAME;
//            SupportStatusCode(MyComment.iSTAND, lblFinanceStand, btnFinSig);
//        }
//    }
//    catch (System.Exception ex)
//    {
...
//private void GetGMFinanceComments()
//{
//    try
//    {
//        GMFinanceComments MyComment = new GMFinanceComments(proposal.IDPROPOSAL);
//        appUsers MyRole = new appUsers(MyComment.iIDUSERMGT);
//        if (MyComment.GMFinanceReceivedIP())
//        {
//            lblOUfinDirStand.Text = MyStand(MyComment.iSTAND);
//            //GMfinanceCommentLabel.Text = MyComment.sCOMMENTS;
//            lblOUFinDirector.Text = MyRole.sFULLNAME;
//            SupportStatusCode(MyComment.iSTAND, lblOUfinDirStand, btnOUFinDir);
//        }
//    }
//    catch (System.Exception ex)
//    {
...
//private void GetVPFinanceComments()
//{
//    try
//    {
//        VPFinanceComments MyComment = new VPFinanceComments(proposal.IDPROPOSAL);
//        appUsers MyRole = new appUsers(MyComment.iIDUSERMGT);
//        if (MyComment.VPFinanceReceivedIP())
//        {
//            VPfinanceStandLabel.Text = MyStand(MyComment.iSTAND);
//            //VPfinanceCommentLabel.Text = MyComment.sCOMMENTS;
//            responsibleVPFinLabel.Text = MyRole.sFULLNAME;
//            SupportStatusCode(MyComment.iSTAND, VPfinanceStandLabel, btnVPFIn);
//        }
//    }
//    catch (System.Exception ex)
//    {
